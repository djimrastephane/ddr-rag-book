...
Author it in TikZ, compile with `pdflatex` + `pdftocairo -svg`, generate
a light (black on transparent) and dark (light-gray on transparent)
color variant, and save both to figures/diagrams/pipeline_chNN_{light,dark}.svg
-- see chapter_01.qmd through chapter_12.qmd for 13 worked examples and
figures/diagrams/ for the generator pattern. Do NOT use plain ASCII art
here; it doesn't get the crisp, theme-aware rendering the rest of the
book's diagrams have. -->
