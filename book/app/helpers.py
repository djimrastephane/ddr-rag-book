...
for _chapter in ("chapter_04", "chapter_05", "chapter_09"):
...
def run_query(question: str, filenames: list[str], texts: list[str], model,
    ...
    importing this module for the text helpers above stays cheap.
    """
