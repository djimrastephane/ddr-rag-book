...
Interestingly, this archive's own software (WellEz) sometimes expands its
own abbreviations — every report writes `PJSM, pre job safety meeting`
in full, spelled out inline. But `BHA`, `WOB`, `MWD`, `SPP`, and a dozen
others never get that treatment anywhere in the archive. Real-world
consistency is exactly this uneven — which is precisely why an automated
expander is worth building rather than relying on reports to document
themselves.
