...
Which report had packers fail to set — and why doesn't either search
method alone find it reliably? A query like *"which report had packers
fail to set?"* has both a semantic component (packers, setting, failure —
