...
question
   ↓
answerable by looking up / computing from structured data?
   ↓
   +---------------------+---------------------+
   |                                           |
  yes                                          no
   |                                           |
   v                                           v
query ddr_facts.parquet directly       retrieve + generate (Chapter 5)
   |                                           |
   v                                           v
exact answer, always re-derivable      answer + citations, verify before trusting
```
