...
Why does the exact sentence you need keep landing right on a chunk
boundary? Chapters 1–5 embedded each report as a single unit — fine for a
ten-report sample corpus, unworkable at the full archive's scale. A
single Utah FORGE report already has seven distinct sections (WELL/JOB
