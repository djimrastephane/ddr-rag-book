...
- Latest stable release: [v1.2.1](https://github.com/djimrastephane/ddr-rag-book/releases/tag/v1.2.1) — see [CHANGELOG.md](CHANGELOG.md) for what's new in each release
