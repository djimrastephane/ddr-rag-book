...
- Latest stable release: [v1.4.0](https://github.com/djimrastephane/ddr-rag-book/releases/tag/v1.4.0) — see [CHANGELOG.md](CHANGELOG.md) for what's new in each release
